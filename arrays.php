...
echo "<h2>Indexxed Array<br/></h2>";
//array 1 dimensi dengan index (indexed array)
$buah2an = array("Jeruk","Mangga","Jambu","Durian");

echo "Saya suka buah ".$buah2an[0]. " dan ". $buah2an[2] ."<br />";
