...
//menampilkan nilai variable dari dalam function
    echo "Nilai dari var1 dari dalam fungsi ujiVariableScope adalah $var1 <br />";
//kode progam diatas akan menghasilkan error, karna memanggil variabel global dari dalam function
    echo "Nilai dari var4 dari dalam fungsi ujiVariableScope adalah $var4 <br />";
//kode progam diatas akan menghasilkan error karna memanggil variable local dari fungsi lain
    }

    ujiVariableScope(); //memanggil fungsi ujiVariableScope

//menampilkan nilai variable dari luar function
...
//membuat fungsi 2
    ...
    echo "Nilai dari var4 dari luar fungsi ujiVariableLocal adalah $var4 <br />"; //variable local, tidak dapat dipanggil dari luar fungsi
...
//memanggil fungsi berlatihKeywordGlobal
    ...
    echo "Hasil penjumlahan var2 dan var 3 dari dalam fungsi, menggunakan kata kunci global adalah $var3 <br />";
