...
//while - mengulang blok kode progam selama kondisi terpenuhi
echo "<h2>Perhitungan While</h2>";
while ($penghitung <= 10) {
...
//do..while - mengeksekusi blok kode progam sekali, lalu mengulanginya selama kondisi terpenuhi
...
//for - mengulang blok kode progam sebanyak jumlah yang ditentukan
echo "<br /> <h2>Perulangan For</h2>";
for($y = 1; $y < 20; $y++){
    echo "Hitungan ke $y <br />";
}

//foreach - mengulang blok kode progam sebanyak jumlah elemen himpunan
echo "<br /><h2>Perulangan Foreach</h2>";
$mobil = array ("avanza","xenia","alphard","agya","alya");
